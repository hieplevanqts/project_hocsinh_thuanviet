...
<div class="row text-right mb-3">
    ...
    <div class="card card-outline card-info" id="district_main" ng-controller="userController">
        <div class="card-body p-3">
            ...
            <form class="p-3" action="{{ route('user.postCreate') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                        <div class="col-sm-8">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Nhập họ tên..." name="name" value="{{ old('name') }}"/>
                            </div>
                            <div class="form-group">
                                <label for=""><b>Nhập Email</b></label>
                                <input class="form-control" placeholder="Nhập email..." name="email" value="{{ old('email') }}"/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" placeholder="Nhập lại mật khẩu..." name="re-password" value="{{ old('re-password') }}"/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group text-right">
                                <label for=""><b></b></label>
                                <button type="submit" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> <% action %></button>
