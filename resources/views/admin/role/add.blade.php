    ...
    <div class="content-wrapper">
        <div class="content mt-3">
            <div class="container-fluid">
                <div class="row">
                    <form action="{{ route('role.create') }}" method="post" enctype="multipart/form-data" style="width: 100%;" class="">
                            ...
                            <div class="card card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="type"
                                        placeholder="Nhập type ..viết liền không dấu." value="{{ old('type') }}">
    
                                </div>
                                <div class="form-group">
                                    <label>Mô tả vai trò</label>
                                    <input class="form-control" name="name" placeholder="Tên quyền.." value="{{ old('name') }}">
                                </div>
                            </div>
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <div class="card card-body">
                                        @foreach($permissionsParentItem->permissionsChildrent as $permissionsChildrentItem)
                                            <div class="">
                                                <h5 class="card-title">
                                                    <input type="checkbox" name="permission_id[]" value="{{ $permissionsChildrentItem->id }}" class="mr-2 checkbox_childrent">
                        ...
                        <div class="row mb-5">
                            <div class="col-sm-12 text-right">
                                <button type="submit" class="btn btn-primary mr-3"><i class="fa fa-cloud-upload" aria-hidden="true"></i> Thêm mới</button>
                            </div>
                        </div>
                    </form>
                </div>
